...
from functions.produto_db import cadastro_produto, atualizar_produto, deletar_produto,listar_produto, buscar1_produto,venda_produto
...
def cadastrar():
    ...
    cadastro_produto(conn,nome,qtd,marca)
...
def venda():
    ...
    venda_produto(conn,venda,id_produto,id_cliente,quantidade)
